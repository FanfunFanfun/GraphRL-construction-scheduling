...
MAX_GRPC_MESSAGE_LENGTH_BYTES = 512 * 1024 * 1024
...
class RpcCommunicator(Communicator):
    ...
    def create_server(self):
        ...
        try:
            # Graph observation transport extension. Author: wyf.
            options = [
                ("grpc.so_reuseport", 1),
                ("grpc.max_send_message_length", MAX_GRPC_MESSAGE_LENGTH_BYTES),
                ("grpc.max_receive_message_length", MAX_GRPC_MESSAGE_LENGTH_BYTES),
            ]
