namespace Unity.MLAgents.Sensors
{
    ...
    public struct ObservationSpec
    {
        ...
        /// <summary>
        /// Creates a fixed-size graph observation. Graph extension author: wyf.
        /// </summary>
        public static ObservationSpec Graph(int numTasks, int featureDim, ObservationType obsType = ObservationType.Default)
        {
            var dimProps = new InplaceArray<DimensionProperty>(
                DimensionProperty.Graph,
                DimensionProperty.Graph
            );
            return new ObservationSpec(
                new InplaceArray<int>(numTasks, featureDim),
                dimProps,
                obsType
            );
        }
